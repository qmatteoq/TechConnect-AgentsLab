...
app.MapGet("/destinations", ([FromQuery] string[] tag) =>
{
    List<Destination> destinations = new List<Destination>  
    {
        ...
        new Destination
        {
            ...
            Tags = ["City", "Culture", "Landmarks", "Shopping"]
        },
        new Destination
        {
            Location = "Tokyo",
        ...
        new Destination
        {
            ...
            Tags = ["City", "Beaches", "Culture", "Nightlife"]
        },
        new Destination
        {
            ...
            Tags = ["City", "Beaches", "Culture", "Carnival"]
        },
        new Destination
        {
            Location = "Cape Town",
            ...
            Tags = ["City", "Nature", "Wildlife", "Culture"]
        },
        new Destination
        {
            Location = "Barcelona",
            ...
            Tags = ["City", "Architecture", "Beaches", "Culture"]
        },
        new Destination
        {
            Location = "Dubai",
            ...
            Tags = ["City", "Shopping", "Skyscrapers", "Nightlife"]
        }
    };
